    ...
    def __init__(self, layers):
        ...
        for m in self.modules():
            if isinstance(m, nn.Conv2d):
                ...
                m.weight.data.normal_(0, math.sqrt(2. / n))    #kaiming  init
...
def darknet21(cfg,is_train=True, **kwargs):
    ...
    if is_train and cfg.INIT_WEIGHTS:
        if isinstance(cfg.PRETRAINED, str):
            ...
            raise Exception("darknet request a pretrained path. got [{}]".format(cfg.PRETRAINED))
    return model
...
if __name__ == '__main__':
    ...
    model=darknet53(darkyolo_config.MODEL,is_train=True)
